...
pub(crate) fn load_settings() -> Settings {
    ...
    Settings::new(
        ...
        &v["target_fps"].as_i64(),
        Keybinds::new(
            &v["keybinds_1"]["up"].as_i64(),
            &v["keybinds_1"]["down"].as_i64(),
            &v["keybinds_1"]["left"].as_i64(),
            &v["keybinds_1"]["right"].as_i64(),
            &v["keybinds_1"]["jump"].as_i64(),
            &v["keybinds_1"]["dash"].as_i64(),
        ),
        Keybinds::new(
            &v["keybinds_2"]["up"].as_i64(),
            &v["keybinds_2"]["down"].as_i64(),
            &v["keybinds_2"]["left"].as_i64(),
            &v["keybinds_2"]["right"].as_i64(),
            &v["keybinds_2"]["jump"].as_i64(),
            &v["keybinds_2"]["dash"].as_i64(),
        ),
    )
}
...
pub(crate) fn load_level(level_id: i32) -> Vec<Rectangle> {
    ...
    while level.len() < num_hitboxes as usize {
        level.push(Rectangle::new(
            v[count.to_string()]["x"].as_f64().unwrap() as f32,
